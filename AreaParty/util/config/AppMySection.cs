...
namespace AreaParty.util.config
{
    ...
    public class AppMySection : ConfigurationSection    // 所有配置节点都要选择这个基类
    {
        ...
        public class MyKeyValueCollection : ConfigurationElementCollection        // 自定义一个集合
        {
            ...
            {
                return ((MyKeyValueSetting)element).AppName;
            }
        ...
        public class MyKeyValueSetting : ConfigurationElement    // 集合中的每个元素
        {
            ...
            [ConfigurationProperty("packageName", IsRequired = true)]
            public string PackageName
            {
                get { return this["packageName"].ToString(); }
