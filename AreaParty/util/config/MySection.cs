...
namespace AreaParty.util.config
{
    public class MySection : ConfigurationSection    // 所有配置节点都要选择这个基类
    {
        ...
        public class MyKeyValueSetting : ConfigurationElement    // 集合中的每个元素
        {
            ...
            [ConfigurationProperty("dlna", IsRequired = true)]
            public string Dlna
            {
                get { return this["dlna"].ToString(); }
                set { this["dlna"] = value; }
            }
            [ConfigurationProperty("miracast", IsRequired = true)]
            public string Miracast
            {
                get { return this["miracast"].ToString(); }
                set { this["miracast"] = value; }
            }
        }
