...
namespace AreaParty.info.media
{
    ...
    {
        public string width { set; get; }//宽度
        public string height { set; get; }//感度
        ...
        public ImageItem(string fileName) : base(fileName)
        {
            ...
            this.width = "800";//img.Width.ToString();
            this.height = "800";//img.Height.ToString();
            ...
            //    this.thumbnailurl = "http://" + GetInternalIP() + ":" + 8634 + "/" + this.name + this.fileSize.Trim() + ".jpg";
            //    mediaInfo.Close();
            //}
        }
        /**//// <summary> 
        ...
        {
            Image originalImage = Image.FromFile(this.pathName);
